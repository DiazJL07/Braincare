...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Inicializar dropdown de Artículos
  try {
    const articlesDropdown = document.querySelector('#articlesDropdown');
    if (articlesDropdown) {
      setupManualDropdown(articlesDropdown);
      console.log('Dropdown de Artículos inicializado');
    }
  } catch (e) {
    console.error('Error al inicializar dropdown de Artículos', e);
  }
